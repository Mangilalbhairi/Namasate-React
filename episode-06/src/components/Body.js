...
const Body = () => {
  ...
  const fetchData = async () => {
    let data = await fetch(
      "https://www.swiggy.com/dapi/restaurants/list/v5?lat=27.592137634317602&lng=75.16480889171362&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
    );
...
// <--- Return Body Component --->
  ...
  return filterReastrantList.length === 0 ? <Shimer/> : (
    <>
      <div className="Body">
        ...
        <div className="filter-container">
          ...
          <input type="text" name="username" className="search-box" value={searchText} onChange={inputText}/>
          <button className="btn" onClick={searchCard}>Search</button>
